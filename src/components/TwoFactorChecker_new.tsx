                  ...
                  <div className="border-t border-gray-200 dark:border-gray-700 p-4">
                    {data?.loading ? (
                      ...
                      <div className="space-y-4">
                        {/* Compliance Overview */}
                        {(() => {
                          const stats = getComplianceStats(data.members);
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="grid grid-cols-4 gap-4 mb-6">
                                ...
                                <div className={`p-4 rounded-lg text-center ${
                                  stats.compliancePercentage >= 95 ? 'bg-green-50 dark:bg-green-900/20' :
                                  stats.compliancePercentage >= 80 ? 'bg-yellow-50 dark:bg-yellow-900/20' :
                                  ...
                                  <div className={`text-sm ${
                                    stats.compliancePercentage >= 95 ? 'text-green-800 dark:text-green-200' :
                                    stats.compliancePercentage >= 80 ? 'text-yellow-800 dark:text-yellow-200' :
